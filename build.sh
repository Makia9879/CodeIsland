...
build_mac() {
    ...
    # Intel/x86_64 universal builds are intentionally disabled for local Apple Silicon use.
    # To restore universal output, build --arch x86_64 as well and lipo both arch products.
    ...
    chmod +x "$APP_BUNDLE/Contents/MacOS/$APP_NAME" "$APP_BUNDLE/Contents/Helpers/codeisland-bridge"
