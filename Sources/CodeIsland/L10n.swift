...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "sessions": "Sessions",
        "cleanup_exited_sessions": "Clean Exited Sessions",
        "cleanup_exited_sessions_desc": "Check session liveness and remove sessions whose process or app has exited",
        "cleanup_exited_sessions_removed": "Removed %d exited sessions",
        ...
        "collapsed_width": "Collapsed Island Width",
        "collapsed_width_desc": "Set the resting island width on notchless displays",
        "collapsed_width_auto_notch": "Matches notch",
        "collapsed_width_auto_notch_desc": "Notched displays use the physical notch width automatically",
        "hover_preview_width_limit": "Hover Preview Width",
        "hover_preview_width_limit_desc": "Maximum top-bar width while hovering before the panel opens",
    ...
    private static let zh: [String: String] = [
        ...
        "sessions": "会话",
        "cleanup_exited_sessions": "清理已退出会话",
        "cleanup_exited_sessions_desc": "检查会话存活状态，并移除进程或应用已退出的会话",
        "cleanup_exited_sessions_removed": "已移除 %d 个已退出会话",
        ...
        "collapsed_width": "收起宽度",
        "collapsed_width_desc": "设置无刘海屏上的灵动岛收起宽度",
        "collapsed_width_auto_notch": "匹配刘海",
        "collapsed_width_auto_notch_desc": "有刘海屏会自动使用真实刘海宽度",
        "hover_preview_width_limit": "悬停预览宽度",
        "hover_preview_width_limit_desc": "鼠标悬停后、面板展开前的顶部条最大宽度",
    ...
    private static let ja: [String: String] = [
        ...
        "sessions": "セッション",
        "cleanup_exited_sessions": "終了したセッションを整理",
        "cleanup_exited_sessions_desc": "セッションの稼働状態を確認し、プロセスまたはアプリが終了したセッションを削除します",
        "cleanup_exited_sessions_removed": "%d 件の終了済みセッションを削除しました",
        ...
        "collapsed_width": "折りたたみ時の幅",
        "collapsed_width_desc": "ノッチのないディスプレイで待機時のアイランド幅を設定します",
        "collapsed_width_auto_notch": "ノッチに合わせる",
        "collapsed_width_auto_notch_desc": "ノッチ付きディスプレイでは物理ノッチ幅を自動使用します",
        "hover_preview_width_limit": "ホバープレビュー幅",
        "hover_preview_width_limit_desc": "パネルが開く前、ホバー中のトップバー最大幅です",
    ...
    private static let ko: [String: String] = [
        ...
        "sessions": "세션",
        "cleanup_exited_sessions": "종료된 세션 정리",
        "cleanup_exited_sessions_desc": "세션 실행 상태를 확인하고 프로세스나 앱이 종료된 세션을 제거합니다",
        "cleanup_exited_sessions_removed": "종료된 세션 %d개를 제거했습니다",
        ...
        "collapsed_width": "접힌 아일랜드 너비",
        "collapsed_width_desc": "노치가 없는 디스플레이에서 대기 중인 아일랜드 너비를 설정합니다",
        "collapsed_width_auto_notch": "노치에 맞춤",
        "collapsed_width_auto_notch_desc": "노치가 있는 디스플레이는 실제 노치 너비를 자동으로 사용합니다",
        "hover_preview_width_limit": "호버 미리보기 너비",
        "hover_preview_width_limit_desc": "패널이 열리기 전 호버 중인 상단 바의 최대 너비입니다",
    ...
    private static let tr: [String: String] = [
        ...
        "sessions": "Oturumlar",
        "cleanup_exited_sessions": "Çıkmış Oturumları Temizle",
        "cleanup_exited_sessions_desc": "Oturum canlılığını kontrol eder ve süreci ya da uygulaması kapanmış oturumları kaldırır",
        "cleanup_exited_sessions_removed": "%d çıkmış oturum kaldırıldı",
        ...
        "collapsed_width": "Daraltılmış Ada Genişliği",
        "collapsed_width_desc": "Çentiksiz ekranlarda bekleme durumundaki ada genişliğini ayarla",
        "collapsed_width_auto_notch": "Çentikle eşleşir",
        "collapsed_width_auto_notch_desc": "Çentikli ekranlarda fiziksel çentik genişliği otomatik kullanılır",
        "hover_preview_width_limit": "Üzerine Gelme Önizleme Genişliği",
        "hover_preview_width_limit_desc": "Panel açılmadan önce üzerine gelince üst çubuğun en büyük genişliği",
